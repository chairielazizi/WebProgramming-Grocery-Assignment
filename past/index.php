  ...
  <main id="container">
    <div class="form shadow rounded">
      <form class="needs-validation" action="processLogin.php?action=login" method="POST" novalidate>
        ...
        <h4 class="font-weight-bold text-center pt-3">Please Sign In</h4>
        <hr>
        <div class="form-group mx-5">
          <label for="inputEmail">Email: </label>
          <input type="email" id="inputEmail" name="inputEmail" class="form-control col-sm-12"
        ...
        <div class="form-group mx-5">
          ...
          <input type="password" id="inputPassword" name="inputPassword" class="form-control col-sm-12"
            placeholder="Password" required>
          <div class="invalid-feedback">
            Please fill in correct password.
          </div>
        </div>
        <a class="ml-4 pl-4 mb-1 btn text-primary" data-toggle="modal" data-target="#passwordModal" role="button">Forgot
          Password? &raquo;</a><br>
        ...
        <p class="text-dark text-right mt-2 mb-0">New to TroliMart? <a class="btn pt-0" id="newToTroliMart"
            href="signup.php" role="button">Sign Up &raquo;</a></p>
      </form>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body shadow rounded">
            <form class="needs-validation2" action="processLogin.php?action=forgotPassword" method="POST" novalidate>
              <div class="form-group mx-5">
                <input type="email" class="form-control mb-1 validate" placeholder="Email" id="fInputEmail"
                  name="fInputEmail" required>
                <div class="invalid-feedback">
                  Please fill in valid email.
                </div>
              </div>
              <div class="form-group mx-5">
                <input type="password" class="form-control mb-1 validate" placeholder="New Password" id="fInputPassword"
                  name="fInputPassword" required>
                <div class="invalid-feedback">
                  Password length must be between 8 to 10 characters with atleast one uppercase letter, one lowercase
                  letter and one number.
                </div>
              </div>
              <div class="form-group mx-5">
                <input type="password" class="form-control validate" placeholder="Confirm New Password"
                  id="fConfirmPassword" name="fConfirmPassword" required>
                <div class="invalid-feedback">
